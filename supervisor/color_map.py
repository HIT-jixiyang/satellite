...
if __name__ == "__main__":
    ...
    # print(time.time() - a)
    src_path_1='/extend/sml_data/2018_process/'
    des_path_1='/extend/sml_data/display_2018_process/201803192100/pred'
    multi_process_transfer(src_path_1,des_path_1)
    src_path_2 = '/extend/sml_data/2018_process_h/'
    des_path_2 = '/extend/sml_data/display_2018_process_h/201803192100/pred'
    os.system(r'../post_processing/fast_hist' + ' ' + src_path_1+' '+src_path_2)
    multi_process_transfer(src_path_2+'/201803192100/pred',des_path_2)
