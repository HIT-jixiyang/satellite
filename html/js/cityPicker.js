...
;var IIInsomniaCityPicker = function(options){
    this.template = $('<div class="IIInsomnia-city-picker" id="IIInsomnia_city_picker"><div class="IIInsomnia-hot-wrap"><ul id="IIInsomnia_hot_city"></ul></div><div class="line"></div><div class="IIInsomnia-wrap"><ul class="IIInsomnia-province-wrap" id="IIInsomnia_province_wrap"></ul></div></div>');
...
IIInsomniaCityPicker.prototype = {
    ...
    buildHotCityTpl: function(){
        ...
        that.hot_city.html(hot_city_html);
		    var val4=$("#IIInsomnia_hot_city ul").find("li").get(4);    //注意：这里的下标从零开始
    },
